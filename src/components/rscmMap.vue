<template>
  <img src="@/assets/logo-blue.png" class="my-3 img-fluid">
  <div class="container-fluid">
    <div class="row">
      ...
      <div class="col-4 container-fluid border border-secondary mx-0" style="background: #ffffff;">
        <div class="row m-5">
          <img class="col-1 img-fluid p-2" src="@/assets/svg/warning.svg">
          <span class="col display-6 text-start px-4 fw-bolder pt-1">실시간 범죄 발생 현황</span>
        </div>
        <div class="row border-bottom border-secondary m-5"></div>
        <div class="row m-5">
          <img class="col-1 img-fluid p-2" src="@/assets/svg/pie-chart.svg">
          <span class="col display-6 text-start px-4 fw-bolder pt-1">최근 범죄 동향 통계</span>
        </div>
        <div class="row border-bottom border-secondary m-5"></div>
      </div>
