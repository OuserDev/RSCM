<template>
    <div class="col-4 border border-secondary ms-4 mt-3 px-0 mh-100 boxCs" style="height: 90%;">
        ...
        <div class="text-start row mx-2 my-0 tight-spacing2 ">
          <div @click="showNothingToast()" class="col-4 border border-secondary ms-2 me-1">
          ...
          <div @click="showNothingToast()" class="text-start col border border-secondary mx-1">
          ...
          <div @click="showNothingToast()" class="text-start col border border-secondary ms-1 me-2">
        ...
        <div class="text-start row mx-2 mt-2 mb-0 tight-spacing2">
          <!-- 검색 대상 지정 바-->
          <div @click="showNothingToast()" class="col-4 border border-secondary bg-white ms-2 py-2">
          ...
          <!-- 검색어 창-->
          <div @click="showNothingToast()" class="col-6 border border-secondary text-start h-auto mx-2 py-2 bg-white">
              <span class="ml-3 h6 textCs">검색어</span>
          </div>
          <!-- 검색버튼-->
          <div @click="showNothingToast()" class="col btn btn-primary border-0 ms-1 me-2 px-0 py-2" style="background-color: #003478;" >
        ...
        <div class="row tight-spacing2 mx-4 mt-2">
          <div @click="일괄모드()" class="col p-0 btn boxCs2 py-3"
