...
export default {
  ...
  methods: {
    ...
    initializeMap() {
      ...
      const mapOption = {
        center: new kakao.maps.LatLng(36.370998, 129.23787), // 지도 중심 좌표
      ...
      const markerImage = new kakao.maps.MarkerImage(
        ...
        markerPosition = new kakao.maps.LatLng(36.370998, 129.23787); // 마커 위치
      ...
      // 정보박스에 표출될 내용
      const iwContent =
          '<div style="padding:5px;">test <br><a href="https://map.kakao.com/link/map/안녕하세요!,36.370998,129.237870" style="color:blue" target="_blank">큰지도보기</a> <a href="https://map.kakao.com/link/to/안녕하세요!,36.370998,129.237870" style="color:blue" target="_blank">길찾기</a></div>',
        iwPosition = new kakao.maps.LatLng(36.370998, 129.23787); // 인포윈도우 표시 위치
    ...
    overlaySet(name, points, index) {
      ...
      this.overlayMap[index] = overlay; // 수정된 부분
    },
